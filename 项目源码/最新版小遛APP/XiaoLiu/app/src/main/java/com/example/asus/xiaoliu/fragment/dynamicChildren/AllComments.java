        ...
        selectDynamic.findObjects(new FindListener<Dynamic>() {
            ...
            public void done(List<Dynamic> list, BmobException e) {
                if(e==null){
                    ...
                    Glide.with(getApplicationContext()).load(bmobFile.getUrl()).into(imgTX);
                    TextView tvDate = findViewById(R.id.date);
                    TextView tvDecribe=findViewById(R.id.dynamic_item_txt);
                    tvDecribe.setText(dy.getDynamicContent());
                    //发布时间
                    ...
                    selectUser.findObjects(new FindListener<User>() {
                        ...
                        public void done(List<User> list, BmobException e) {
                            if(e==null){
                                ...
                                Glide.with(getApplicationContext()).load(bmobFile.getUrl()).apply(requestOptions).into(ivImg);
