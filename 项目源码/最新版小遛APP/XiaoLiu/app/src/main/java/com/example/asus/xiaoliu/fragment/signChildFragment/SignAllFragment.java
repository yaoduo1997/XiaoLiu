...
import com.example.asus.xiaoliu.Async.SignAsy.SignAllAsy;
...
public class SignAllFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        new SignAllAsy(listView,getActivity()).executeOnExecutor(Executors.newCachedThreadPool());
        return v;
    }
}
